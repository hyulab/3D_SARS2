...
uniprot_info = pd.read_csv("[REDACTED_PATH]/eclair/data/uniprot_info.txt", sep="\t")
...
interactions2 = pd.read_csv("[REDACTED_PATH]/Collaborators/Eclair_Runs/2020_04_22_COVID19_Human_Interactome/Interactions.txt", sep="\t", names=["P1", "P2"])
...
pfam_doms = pd.read_csv("[REDACTED_PATH]/eclair/features/per_feature/pfam_domains.txt", names=["ID", "Is_Domain"], sep="\t")
