...
init(extra_options = "-constant_seed") # WARNING: option '-constant_seed' is for testing only! MAKE SURE TO REMOVE IT IN PRODUCTION RUNS!!!!! import os; 
os.chdir("[REDACTED_PATH]/Collaborators/Lab_Member_Requests/Charles/2020_05_04_COVID19_Website/Data/ddG_Single_Mutants" )
        ...
        for i in range(1, pose.total_residue() + 1):
            ...
            if i in iresA or i in iresB:
                ...
                if output:
                    ...
                    filename = os.path.abspath("docking_output/" + os.path.basename(filename))
